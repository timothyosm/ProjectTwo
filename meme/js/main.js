(function MemeGenerator() {
  ...
  const downloadMemeModalCloseBtn = document.getElementById(
    "downloadMemeModalCloseBtn"
  );
  ...
  function onImageLoaded(evt) {
    ...
    canvasPlaceholder.removeEventListener(
      "click",
      handleCanvasPlaceholderClick,
      false
    );
  ...
  function createNewInput(index) {
    const inputTemplate = `
      <div class="d-flex">
        <input class="form-control m-2" type="text" data-input="text" autocomplete="off" placeholder="${
          index === 0
            ? "Top Text"
            : index === 1
            ? "Bottom Text"
        ...
        <div class="d-flex align-items-center pr-2">
          <input class="form-control" type="color" value="${
            options[index].fillColor
          }" data-input="fillColor" title="Fill color">
          <input class="form-control" type="color" value="${
            options[index].shadowColor
          }" data-input="shadowColor" title="Outline color">
      ...
      <div class="p-2 d-none" data-section="settings">
        <div class="form-row">
          ...
          <div class="col-lg-6 mb-3">
            ...
            <input class="form-control" type="number" min="1" max="100" value="${
              options[index].fontSize
            }" data-input="fontSize">
          </div>
        </div>
        <div class="form-row">
          <div class="col-lg-6 mb-3">
            ...
            <input class="form-control" type="number" min="0" max="10" value="${
              options[index].shadowBlur
            }" data-input="shadowBlur">
          </div>
          <div class="col-lg-6 mb-3">
        ...
        <div class="form-row">
          <div class="col-lg-6 mb-3">
            ...
            <input class="form-control" type="number" value="${
              options[index].offsetY
            }" data-input="offsetY">
          </div>
          <div class="col-lg-6 mb-3">
            <label class="mb-1">Horizontal offset:</label>
            <input class="form-control" type="number" value="${
              options[index].offsetX
            }" data-input="offsetX">
          </div>
        </div>
        <div class="form-row">
    ...
    div.querySelector('[data-input="textAlign"]').value =
      options[index].textAlign;
    div.querySelector('[data-input="allCaps"]').checked =
      options[index].allCaps;
    return fragment.appendChild(div);
  }

  function onAddTextboxBtnClicked() {
    const textBoxesLength = document.querySelectorAll('[data-input="text"]')
      .length;
  ...
  canvasPlaceholder.addEventListener(
    "click",
    handleCanvasPlaceholderClick,
    false
  );
  ...
  cancelUserMediaBtn.addEventListener(
    "click",
    () => {
      toggleModal(videoModal, false);
      stopVideoStreaming(video);
  ...
  downloadMemeBtn.addEventListener(
    "click",
    () => toggleModal(downloadModal, false),
    false
  );
  downloadMemeModalCloseBtn.addEventListener(
    "click",
    () => toggleModal(downloadModal, false),
    false
  );
  ...
  inputsContainer.addEventListener(
    ...
    evt => {
      const element = evt.target;
      const index = Number(
        element.closest('[data-section="textBox"]').getAttribute("data-index")
      );
      let prop;
